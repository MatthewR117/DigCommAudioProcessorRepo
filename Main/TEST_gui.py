...
# Note that this is a TEST for the pentiometer stuff.
try:
    import spidev
    SPI_AVAILABLE = True
except Exception:
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def audio_callback(self, indata, outdata, frames, time, status):
        ...
        mode = self.main_window.liveFilterMode
        #processed = applyLiveFilter(audio, self.sample_rate, mode) # Commented out for testing.
        processed = applyLiveFilter(audio, self.sample_rate, mode, q_factor = self.main_window.get_current_q())
